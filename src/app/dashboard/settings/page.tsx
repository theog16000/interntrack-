  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400 text-sm mt-1">Gère ton compte et tes préférences</p>
      </div>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-6">
            <div className="flex items-center gap-2 mb-5">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Modifie ton adresse email de connexion</p>
              </div>
            </div>
            <form onSubmit={handleUpdateEmail} className="space-y-4">
              ...
              <button type="submit" disabled={savingEmail || email === user?.email} className="flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white rounded-lg text-sm font-medium hover:bg-indigo-700 disabled:opacity-50 transition-colors">
                <Save size={14} />
                {savingEmail ? 'Sauvegarde...' : 'Mettre à jour'}
              </button>
            </form>
          </div>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-6">
            <div className="flex items-center gap-2 mb-5">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Change ton mot de passe de connexion</p>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-9 py-2.5 border border-gray-200 rounded-lg text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 bg-white"
                    placeholder="••••••••"
                    required
                  />
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between py-2">
                <span className="text-xs text-gray-500">ID utilisateur</span>
                <span className="text-xs font-mono text-gray-400">{user?.id?.slice(0, 16)}...</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-red-100 rounded-xl p-6">
            <div className="flex items-center gap-2 mb-5">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Actions irréversibles sur ton compte</p>
              </div>
            </div>
            <div className="bg-red-50 rounded-xl p-4 mb-4">
              <p className="text-xs text-red-600 font-medium mb-1">Supprimer mon compte</p>
              <p className="text-xs text-red-400">
                Cette action est irréversible. Toutes tes candidatures, documents, entretiens et entreprises seront définitivement supprimés.
              </p>
            </div>
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 border border-red-200 rounded-lg text-sm text-gray-900 placeholder:text-gray-300 focus:outline-none focus:border-red-400 focus:ring-1 focus:ring-red-400 bg-white font-mono"
                />
              </div>
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-red-500 text-white rounded-lg text-sm font-medium hover:bg-red-600 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
              >
                <Trash2 size={14} />
